...
const data = {
  ...
  title: 'Your Buisness Goals Are Achievable',
  features: [
    {
      id: 1,
      imgSrc: Smart,
    ...
    },
    {
      ...
      text:
        'RU uses the most up-to-date security protocols and version control tools to ensure your projects are away from the prying eyes of hackers.',
    },
  ],
};
