      ...
      <Container sx={styles.banner.container}>
        <Box sx={styles.banner.contentBox}>
          ...
          <Text as='p' variant='heroSecondary'> 
            Explore software and design solutions RU has created for clients. Contact us to find out if our scalable development teams are the right fit for your project.
          </Text>
